...
/**
 * @notice Script to deploy and setup all needed contracts for the protocol with GoalBasedPaymentTreasury
 */
contract DeployAllAndSetupGoalBasedPaymentTreasury is DeployBase {
    ...
    address goalBasedPaymentTreasuryImplementation;
    ...
    bool goalBasedPaymentTreasuryDeployed = false;
    ...
    function setupParams() internal {
        ...
        goalBasedPaymentTreasuryImplementation =
            vm.envOr("GOAL_BASED_PAYMENT_TREASURY_IMPLEMENTATION_ADDRESS", address(0));
    ...
    function deployContracts() internal {
        ...
        // Deploy or reuse GoalBasedPaymentTreasury implementation
        if (goalBasedPaymentTreasuryImplementation == address(0)) {
            goalBasedPaymentTreasuryImplementation = address(new GoalBasedPaymentTreasury());
            goalBasedPaymentTreasuryDeployed = true;
            console2.log(
                "GoalBasedPaymentTreasury implementation deployed at:", goalBasedPaymentTreasuryImplementation
            );
        } else {
            console2.log(
                "Reusing GoalBasedPaymentTreasury implementation at:", goalBasedPaymentTreasuryImplementation
            );
        }
    }
    ...
    function registerTreasuryImplementation() internal {
        ...
        if (!treasuryFactoryDeployed && !goalBasedPaymentTreasuryDeployed) {
    ...
    function run() external {
        ...
        console2.log("GOAL_BASED_PAYMENT_TREASURY_IMPLEMENTATION:", goalBasedPaymentTreasuryImplementation);
