...
contract PledgeNFT_Test is Base_Test {
    ...
    function setUp() public override {
        ...
        globalParams.enlistPlatform(PLATFORM_HASH, users.platform1AdminAddress, PLATFORM_FEE_PERCENT);
        ...
        address treasuryAddress = treasuryFactory.deploy(
            PLATFORM_HASH,
            campaignAddress,
            1
        );
    ...
    function test_TreasuryCanMintNFT() public {
        ...
        uint256 tokenId = campaign.mintNFTForPledge(
            users.backer1Address,
            bytes32(0),
            address(testToken),
            100e18,
    ...
    function test_TokenIdIncrementsAndNeverReuses() public {
        // Mint first NFT
        vm.prank(address(treasury));
        uint256 tokenId1 = campaign.mintNFTForPledge(
            users.backer1Address,
            bytes32(0),
            address(testToken),
            100e18,
        ...
        // Mint second NFT
        vm.prank(address(treasury));
        uint256 tokenId2 = campaign.mintNFTForPledge(
            users.backer1Address,
            bytes32(0),
            address(testToken),
            100e18,
        ...
        vm.prank(address(treasury));
        uint256 tokenId3 = campaign.mintNFTForPledge(
            users.backer1Address,
            bytes32(0),
            address(testToken),
            100e18,
