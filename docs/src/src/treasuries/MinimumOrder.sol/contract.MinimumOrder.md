...
*Constructor for the MinimumOrder contract.*
...
### RefundClaimed
*Event emitted when a refund is claimed by a backer.*
...
*Throws an error indicating that the pre-order transfer failed.*
...
*Throws an error indicating that the pre-order input is invalid.*
