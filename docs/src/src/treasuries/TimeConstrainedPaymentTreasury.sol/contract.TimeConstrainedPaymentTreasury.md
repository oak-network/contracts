...
[Git Source](https://github.com/oak-network/contracts/blob/6c7f67f5ed14ef0f4f9444b95ac6770ae2af756a/src/treasuries/TimeConstrainedPaymentTreasury.sol)
...
Internal function to check if current time is within the campaign window (launchTime to deadline + bufferTime).
...
Internal function to check if current time is after launch time.
